...
class CarePlanViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let constraints = [
            trainingButton.topAnchor.constraint(equalTo: guide.topAnchor, constant: 20),
            trainingButton.bottomAnchor.constraint(equalTo: guide.centerYAnchor, constant: -20),
            trainingButton.leftAnchor.constraint(equalTo: guide.leftAnchor, constant: 20),
            trainingButton.rightAnchor.constraint(equalTo: guide.centerXAnchor, constant: -20),
    ...
    private var trainingButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(trainingButtonAction), for: .touchUpInside)
        return button
    }()
    ...
    // MARK: Button Actions
    @objc private func trainingButtonAction() {
