...
//
//  Created by Céline Aldenhoven on 11.05.23.
//
...
public var ConsentDocument: ORKConsentDocument {
    ...
    consentDocument.addSignature(ORKConsentSignature(forPersonWithTitle: "Caregiver study participant", dateFormatString: Date().formatted(), identifier: "ConsentDocumentParticipantSignature"))
