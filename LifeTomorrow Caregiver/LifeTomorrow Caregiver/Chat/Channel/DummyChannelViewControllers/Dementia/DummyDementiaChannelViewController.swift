//
//  DummyDementiaChannelViewController.swift
...
class DummyDementiaChannelViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    
    private var posts = DementiaPostsAPI.getPosts() // model
    ...
    var imageView: UIImageView = {
        ...
        view.image = UIImage(named: "dementiaChannelBackground")
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        tableView.deselectRow(at: indexPath, animated: true)
            ...
            let dummyChatImage = UIImage(named: "dummyDementiaChannel" + "\(currentCell.titleLabel.text!)")
