//
//  DummyRemoteCareChannelViewController.swift
...
class DummyRemoteCareChannelViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    
    private var posts = RemoteCarePostsAPI.getPosts() // model
    ...
    var imageView: UIImageView = {
        ...
        view.image = UIImage(named: "remoteCareChannelBackground")
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        tableView.deselectRow(at: indexPath, animated: true)
            ...
            let dummyChatImage = UIImage(named: "dummyRemoteCareChannel" + "\(currentCell.titleLabel.text!)")
